...
import { AUTOPLAY_STATE, PAUSE_STATE } from "#mirai/data/Constants.js";
import { parseTime } from "#mirai/utils/functions/utils.js";
...
export default new Lavalink({
  ...
  run: async (client, player, track) => {
    ...
    const isAutoplay =
      player.get<boolean | undefined>("enabledAutoplay") ?? false;
